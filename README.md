...
3. Paste `https://raw.githubusercontent.com/TomG777/steamSummerMinigame/master/autoPlay.user.js` into the text area, and click `Import`.
4. When the editor has loaded, click `Install` (*NOT* `Process with Chrome`).

### Greasemonkey ###

1. Navigate to `https://raw.githubusercontent.com/TomG777/steamSummerMinigame/master/autoPlay.user.js`.
...
##### Chrome #####
1. Open https://raw.githubusercontent.com/TomG777/steamSummerMinigame/master/autoPlay.user.js
2. Select All, Copy.
...
1. Open https://raw.githubusercontent.com/TomG777/steamSummerMinigame/master/autoPlay.user.js
2. Select All, Copy.
3. Navigate to `https://monsterminigame.doctormckay.com` and join or start a game.
